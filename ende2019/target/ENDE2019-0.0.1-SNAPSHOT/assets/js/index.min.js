...
var mySwiper = new Swiper(".swiper-container", {
	...
	initProductSticky = function() {
		$(".index-product-series").on("sticky-start", function() {
			$("#sticky-wrapper").height("5em"), $(".index-product-series").css({
				padding: "0"
			}).addClass("align-horizontal").removeClass("align-vertical")
		}).on("sticky-end", function() {
			$("#sticky-wrapper").height("auto"), $(".index-product-series").css("padding", "4.5em 0").addClass("align-vertical").removeClass("align-horizontal")
		}).sticky({
			topSpacing: 0,
			zIndex: 50
		})
